...
/**
 * Turns raw YouTube API payloads into the flat shapes the report is built from.
 *
 * Ported from `server/services/youtubeApi.service.js`. The field names are kept exactly as they
 * were: the Insight OS UI reads these keys directly, and renaming them to something tidier would
 * mean editing a 1,700-line component for no behavioural gain.
 */
